...
class ApiService {
  ...
  bool responseDecision = false;
  bool responseAgeRestricted = true;
  ...
  Future<Map<String, dynamic>> requestLoanDecision(
    ...
    try {
      ...
      responseDecision = responseData['decision'];
      responseAgeRestricted = responseData['ageRestricted'];
      ...
      return {
        ...
        'ageRestricted': responseAgeRestricted,
      };
    } catch (e) {
